 ...
 * @author georgia
 */
@WebServlet(name = "BookingsNumber", urlPatterns = {"/BookingsNumber"})
public class BookingsNumber extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (su != null) {
                ...
                int sum = c.getBookingsCountForKeeper(String.valueOf(keeper_id));
